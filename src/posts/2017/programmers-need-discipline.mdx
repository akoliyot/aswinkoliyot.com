...
import { PhotoSwipeInitializer } from '../../components/PhotoSwipeInitializer';
...
<Slider>
  <div><img src={ImageDetails1} /></div>
  <div><img src={ImageDetails2} /></div>
  <div><img src={ImageProperties} /></div>
  <div><img src={Latest} /></div>
...
<ModalGateway>
        {true ? (
          <Modal onClose={this.toggleModal}>
            <Carousel views={[{ src: Settings} , {src: Search }]} />
          </Modal>
        ) : null}
      </ModalGateway>
