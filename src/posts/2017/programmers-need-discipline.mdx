...
import ImageDetails1 from './../../images/posts/2017/wallhaven-image-page.png';
import ImageDetails2 from './../../images/posts/2017/wallhaven-image-page-2.png';
import ImageProperties from './../../images/posts/2017/wallhaven-image-properties.png';
import Latest from './../../images/posts/2017/wallhaven-image-properties.png';
import Random from './../../images/posts/2017/wallhaven-random.png';
import Search from './../../images/posts/2017/wallhaven-search.png';
import Settings from './../../images/posts/2017/wallhaven-settings.png';
import TilesWithBg from './../../images/posts/2017/wp-tiles-with-bg.png';
...
<SRLWrapper className="asdf" options={{ showThumbnails: false, showCaption: false }}>
  <div className="asdf">
    <div><img src={ImageDetails1} alt="1" /></div>
    <div><img src={ImageDetails2} alt="1" /></div>
    <div><img src={ImageProperties} alt="1" /></div>
    <div><img src={Latest} alt="1" /></div>
    <div><img src={Random} alt="1" /></div>
    <div><img src={Search} alt="1" /></div>
    <div><img src={Settings} alt="1" /></div>
  </div>
</SRLWrapper>
...
<figure>
  <img src={TilesWithBg} />
  <figcaption>Tile background images on Windows Phone 8.1 © Microsoft Corporation</figcaption>
</figure>
